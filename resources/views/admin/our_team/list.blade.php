...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <a href="{{ route('our-team.create') }}" class="btn btn-primary" style="display:block;float:right;">Add Our Team</a>&nbsp;
            <a class="btn btn-danger" id="deleteDebtbtn" style="display:block;float:right;margin-right: 10px;">Delete</a>
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Our Team Tables</h4>
      ...
      <div class="card">
        ...
        <div class="table-responsive text-nowrap">
          <table class="table" id="testimonial_list">
            <thead>
              <tr>
            ...
            <tbody class="table-border-bottom-0 sort_body">
                @php
                    $count = 1;
                @endphp
               @if(isset($ourTeams) && !empty($ourTeams))
                    ...
                    @php
                        ...
                        if (strlen($item->description) <= 20) {
                            ...
                            $content = substr($item->description, 0, 20) . '...';
                        }
                    @endphp

                    <tr data-id="{{ $item->id }}" class="row1">
                        <td>
                        ...
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('edit.our-team',[$item->id]) }}"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                            >
                            <a class="dropdown-item" href="{{ route('delete.our-team',[$item->id]) }}"
            ...
            $(document).on('click', '#deleteDebtbtn', function(e) {
                ...
                if (jsAllSelectedIds == '' || jsAllSelectedIds == null) {
                    ...
                    if (confirm('Are you sure to delete this records?')) {
                        var ajax_url = "{{ route('delete_all_our_team') }}";
                        $.ajax({
                            headers: {

...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <a href="{{ route('newsletter.export') }}" class="btn btn-primary" style="display:block;float:right;">Export</a>
            <a class="btn btn-danger" id="deleteDebtbtn" style="display:block;float:right;margin-right: 10px;">Delete</a>
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> NewsLetter Tables</h4>
                 ...
                 @foreach ($newsletter as $item)
                    ...
                    <tr>
                        ...
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('delete.newsletter',[$item->id]) }}"
            ...
            $(document).on('click', '#deleteDebtbtn', function(e) {
                ...
                if (jsAllSelectedIds == '' || jsAllSelectedIds == null) {
                    ...
                    if (confirm('Are you sure to delete this records?')) {
                        var ajax_url = "{{ route('delete_all_newsletter') }}";
                        $.ajax({
                            headers: {

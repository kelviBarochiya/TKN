...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <a href="{{ route('testimonail.create') }}" class="btn btn-primary" style="display:block;float:right;">Add Testimonail</a>&nbsp;
            <a class="btn btn-danger" id="deleteDebtbtn" style="display:block;float:right;margin-right: 10px;">Delete</a>
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Testimonail Tables</h4>
            ...
            <tbody class="table-border-bottom-0">
               ...
               @if(isset($testimonials) && !empty($testimonials))
                    ...
                    <tr>
                        ...
                        <td>{{ Str::limit(html_entity_decode(strip_tags($item->description)), 20) }}</td>
                        <td>
                            @if($item->image != "")
                        ...
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('edit.testimonail',[$item->id]) }}"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                            >
                            <a class="dropdown-item" href="{{ route('delete.testimonail',[$item->id]) }}"
            ...
            $(document).on('click', '#deleteDebtbtn', function(e) {
                ...
                if (jsAllSelectedIds == '' || jsAllSelectedIds == null) {
                    ...
                    if (confirm('Are you sure to delete this records?')) {
                        var ajax_url = "{{ route('delete_all_testimonail') }}";
                        $.ajax({
                            headers: {

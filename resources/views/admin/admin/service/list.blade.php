...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <a href="{{ route('service.create') }}" class="btn btn-primary" style="display:block;float:right;">Add Service</a>&nbsp;
                 ...
                 @foreach ($services as $item)
                    @php
                        ...
                        if (strlen($item->content) <= 20) {
                            ...
                            $content = substr($item->content, 0, 20) . '...';
                        }
                    @endphp
                    ...
                    <tr>
                        ...
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('edit.service',[$item->id]) }}"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                            >
                            <a class="dropdown-item" href="{{ route('delete.service',[$item->id]) }}"
            ...
            $(document).on('click', '#deleteDebtbtn', function(e) {
                ...
                if (jsAllSelectedIds == '' || jsAllSelectedIds == null) {
                    ...
                    if (confirm('Are you sure to delete this records?')) {
                        var ajax_url = "{{ route('delete_all_service') }}";
                        $.ajax({
                            headers: {

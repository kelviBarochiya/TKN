            ...
            <tbody class="table-border-bottom-0">
                ...
                @if(isset($enquiry) && !empty($enquiry))
                 @foreach ($enquiry as $item)
                    @php 
                    if (strlen($item->message) <= 20) {
                            $description = $item->message;
                        } else {
                            $description = substr($item->message, 0, 20) . '...';
                        }
                    @endphp
                    <tr>
                        <td>
                        ...
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('view.service_enquiry',[$item->id]) }}"
                                ><i class="bx bx-trash me-1"></i> View</a
                            >
                            <a class="dropdown-item" href="{{ route('delete.service-enquiry',[$item->id]) }}"

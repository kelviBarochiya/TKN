...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <a href="{{ route('image-setting.create') }}" class="btn btn-primary" style="display:block;float:right;">Add Image Setting</a>&nbsp;
            <a class="btn btn-danger" id="deleteDebtbtn" style="display:block;float:right;margin-right: 10px;">Delete</a>
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Image Setting Tables</h4>
          ...
          <table class="table" id="image_setting">
            ...
            <tbody class="table-border-bottom-0">
                @php
                    $count = 1;
                @endphp
                @if(isset($imageSettings) && !empty($imageSettings))
                 @foreach ($imageSettings as $item)
                    ...
                    <tr>
                        ...
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('edit.image-setting',[$item->id]) }}"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                            >
                            <a class="dropdown-item" href="{{ route('delete.image-setting',[$item->id]) }}"

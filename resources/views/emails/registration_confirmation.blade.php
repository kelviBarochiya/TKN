        ...
        <div class="container">
            ...
            <div class="content">
                <div class="v-font-size"
                    ...
                    <p style="font-size: 14px; line-height: 140%;">The user <strong>{{ $name }}</strong> has
                        registered as a <strong>
                ...
                <p style="font-size: 14px; line-height: 140%;"><span
                        style="color: #7eb1eb; font-size: 14px; line-height: 19.6px;"><strong>&copy; {{ date('Y') }}
                            Auricity. All rights reserved.</strong></span></p>
            </div>
        </div>
    </div>
</body>
